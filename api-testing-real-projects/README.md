...
- Team kỹ thuật cần xem cách tôi triển khai kiểm thử từ manual đến automation

## Lộ Trình Học QA
Đây là lộ trình dài hạn, phát triển theo từng giai đoạn:
1. Nền tảng kiểm thử thủ công
2. Phân tích yêu cầu và lập kế hoạch kiểm thử
3. Dự án kiểm thử web manual
...
- Xây dựng test plan và phạm vi kiểm thử
...
- Hoàn thiện test summary report và bằng chứng kiểm thử
...
- CI/CD (kế hoạch): GitHub Actions, Azure DevOps

## Recruiter/Interviewer
1. Bắt đầu từ README gốc và `learning-roadmap.md`.
